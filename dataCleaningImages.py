...
if __name__ == "__main__":    
    dirpath = 'Flickr_Data/Images/'
    for set_type in ['test','dev','train']:
        with open(f'Flickr_Data/Flickr_TextData/Flickr_8k.{set_type}Images.txt') as fh:
            encoded={}
            t1=process_time()
            ...
            joblib.dump(encoded,f'Flickr_Data/Processed/encoded_{set_type}Images.pkl')
