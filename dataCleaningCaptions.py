...
with open('Flickr_Data/Flickr_TextData/Flickr8k.token.txt') as fh:
    imgCap={}
...
# Train Test CV
with open('Flickr_Data/Flickr_TextData/Flickr_8k.trainImages.txt') as fh:
    train={}
    for line in fh:
        train[line.strip()]=imgCap[line.strip()]

with open('Flickr_Data/Flickr_TextData/Flickr_8k.testImages.txt') as fh:
    test={}
    for line in fh:
        test[line.strip()]=imgCap[line.strip()]

with open('Flickr_Data/Flickr_TextData/Flickr_8k.devImages.txt') as fh:
    cross_validation={}
    for line in fh:
        cross_validation[line.strip()]=imgCap[line.strip()]

makedirs('Flickr_Data/Processed',exist_ok=True)
with open('Flickr_Data/Processed/corpus.json','w') as fh:
    json.dump(imgCap,fh)
with open('Flickr_Data/Processed/train.json','w') as fh:
    json.dump(train,fh)
with open('Flickr_Data/Processed/test.json','w') as fh:
    json.dump(test,fh)
with open('Flickr_Data/Processed/cross_validation.json','w') as fh:
...
for ind,word in enumerate(vocab):
    word2ind[word]=ind
with open('Flickr_Data/Processed/word2ind.json','w') as fh:
...
joblib.dump(embedding_matrix,'Flickr_Data/Processed/word_embedding.pkl')